...
### Work Experience ###
---
* **Align Center for Health Policy** ```United States```                                                        
  * ***Founder & Director*** `July 2022-present` 
    * Founded a student-run interdisciplinary health policy group focused on innovation, advocacy, community-centered solutions, and implementation
    * Securing clients (including the Little Devices Lab) to work on key global health policy problems
    * Collaborating with the Icarus Institute to increase academic representation in publications on policy topics
...
* **North Carolina Integrated Care for Kids (NC InCK) Model & Bass Connections** ```Raleigh, NC```
  * ***Research Intern*** `Nov 2020-present` 
     ...
     * Researching legal aid partnerships and developing community school partnerships and training to widen the reach of screening in the program
     
* **Duke-Margolis Center for Health Policy** ```Washington, D.C.```
  * ***Research Intern*** `May 202-Dec 2022` 
    * Interviewed stakeholders, constructed literature reviews, and developed dissemination materials about the North Carolina Healthy Opportunities Pilot
    * Conducted qualitative analysis, coding information, and developed communications materials regarding telehealth disparities in children and adults with behavioral health and musculoskeletal conditions to inform policy reforms in North Carolina
...
* **Morehead-Cain Scholarship Fund** ```Chapel Hill, NC```                                                        
  * ***Class of 2024 Student Director*** `April 2021-present` 
    ...
    * • Engaging the community alongside Foundation trustees and staff
    * Contributing to strategy and development plans for the future of the scholarship program to enhance program outcomes and equity

* **Campus Y (Center for Social Justice)** ```Chapel Hill, NC```                                                        
  * ***Co-President*** `March 2023-present` 
     * Leading the social justice hub at UNC in mutual aid initatives, direct action, education, social events, etc.
  ...
  * ***Executive Board Member*** `April 2021-March 2023` 
...
### Awards & Honors ###
---
`2022` Balter Philosophy Fellowship

`2021` North Carolina Fellows Program; Oxford Effective Altruism In-Depth Fellow
...
Invented a atmospheric water harvester using hygroscopic material so that it can work in areas of low relative humidity. Patent pending.
